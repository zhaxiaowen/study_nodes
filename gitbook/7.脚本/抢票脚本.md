...
class BrushTicket(object):
    ...
    def __init__(self, passengers, from_time, from_station, to_station, numbers, seat_type, receiver_mobile,
        ...
        self.executable_path = 'D:\\Project\12306\chromedriver.exe'
...
if __name__ == '__main__':
    # 乘客姓名
    passengers = ('赵晓文','王艳芳','赵晓冉','赵永保','汪嘉伟')
    # 乘车日期
    from_time = '2023-01-14'
    ...
    city_list = {
        ...
        'smx': '%u4E09%u95E8%u5CE1%2CSMF',  # 三门峡
    }
    # 出发站
    from_input = 'sz'
    ...
    seat_type = '二等座'
    # 抢票成功，通知该手机号码
    receiver_mobile = '15622245721'
    receiver_email = 'zxw270194330@163.com'
    # 开始抢票
